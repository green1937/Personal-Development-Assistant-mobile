...
public class NewTaskActivity extends AppCompatActivity {
    ...
    */
    public static void spinnerCtg(Context context, ActivityNewTaskBinding binding, TaskViewModel viewModel, String ctgName) {
    ...
    */
    public static void spinnerPlans(Context context, ActivityNewTaskBinding binding, TaskViewModel viewModel, String planName) {
    ...
    protected static void spinnerRepeatEnd(Context context, ActivityNewTaskBinding binding, TaskViewModel viewModel, String end, int numberOfRepeats) {
    ...
    protected static void spinnerRepeat(Context context, ActivityNewTaskBinding binding, TaskViewModel viewModel, String term) {
